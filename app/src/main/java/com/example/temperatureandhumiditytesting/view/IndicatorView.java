...
public class IndicatorView extends LinearLayout {
    ...
    private int textColorId = com.baronzhang.android.widget.R.color.indicator_text_color;// 默认文字颜色
    private int textColor;
    private int indicatorStringsResourceId = com.baronzhang.android.widget.R.array.indicator_strings;
    private int indicatorColorsResourceId = com.baronzhang.android.widget.R.array.indicator_colors;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.baronzhang.android.widget.R.styleable.IndicatorView);
        this.markerId = typedArray.getResourceId(com.baronzhang.android.widget.R.styleable.IndicatorView_marker, com.baronzhang.android.widget.R.drawable.ic_vector_indicator_down);
        this.marker = drawableToBitmap(createVectorDrawable(markerId, com.baronzhang.android.widget.R.color.indicator_color_1));
        this.indicatorValue = typedArray.getInt(com.baronzhang.android.widget.R.styleable.IndicatorView_indicatorValue, indicatorValue);
        this.textSize = typedArray.getDimensionPixelSize(com.baronzhang.android.widget.R.styleable.IndicatorView_textSize, textSize);
        this.intervalValue = typedArray.getDimensionPixelSize(com.baronzhang.android.widget.R.styleable.IndicatorView_intervalSize, intervalValue);
        this.textColor = typedArray.getColor(com.baronzhang.android.widget.R.styleable.IndicatorView_textColor, getResources().getColor(textColorId));
        this.indicatorStringsResourceId = typedArray.getInt(com.baronzhang.android.widget.R.styleable.IndicatorView_indicatorStrings, indicatorStringsResourceId);
        this.indicatorColorsResourceId = typedArray.getInt(com.baronzhang.android.widget.R.styleable.IndicatorView_indicatorColors, indicatorColorsResourceId);
        typedArray.recycle();
    }
