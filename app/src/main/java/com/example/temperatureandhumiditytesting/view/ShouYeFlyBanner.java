 ...
 * #                                                   #
 * #               佛祖保佑         永无BUG              #
 * #            Created  on 2023/2/26/19:54 .
 * #            com.example.bodybuilding.view
 * #            健身大师APP
 */
public class ShouYeFlyBanner extends RelativeLayout {
    ...
    //指示点资源
    private int mPointDrawableResId = R.drawable.lunbo_dian;
    //指示容器背景
    ...
    public ShouYeFlyBanner(Context context) {
        this(context, null);
    }

    public ShouYeFlyBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShouYeFlyBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setLayout(Context context) {
        ...
        //设置内边距
        pointContainerRl.setPadding(0, 10, 0, 15);
        //设定指示器容器布局及位置
    ...
    private class FlyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            View inflate = LayoutInflater.from(App.context).inflate(R.layout.shouye_banner, null);
